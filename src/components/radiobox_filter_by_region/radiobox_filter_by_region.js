...
const Radiobox_filter_by_region = ({
    items,
    onSelectChanged,
    selectedItem= null,
    valueProperty=null,
                ...
                <div className="space-y-2">
                    {
                        items.map((item, itemIdx) => (
                          ...
                          ${
                            ...
                            relative rounded-lg shadow-md px-2 py-1 cursor-pointer flex focus:outline-none translation-color`
                                }>
                                {({checked}) => (
...
export default Radiobox_filter_by_region;